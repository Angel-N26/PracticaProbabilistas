...
public abstract class Funciones {
    ...
    public Funciones(double inf, double sup) {
        ...
        linf = inf;
        lsup = sup;
        intervalo = new double[2]; //para los intevalos de confianza para normales intervaloP
    ...
    public boolean
        ...
        boolean v = x
                ...
                <= lsup();
        if (!v) {
            System.out.println(x + " no pertenece a "
                    + this
            );
        }
        return v;
    ...
    public abstract double area(); //area bien calculada por el metodoque conozcamos
